...
\newcommand{\AssignmentName}{MAT 275 Project 1}
...
Test
% \include{problems/2.5.7}
% \include{problems/3.2.3}
% \include{problems/3.2.5}
% \include{problems/3.2.6}
% \include{problems/3.3.3}
